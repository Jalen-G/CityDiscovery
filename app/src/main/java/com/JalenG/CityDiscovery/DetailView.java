...
import static com.JalenG.CityDiscovery.MainActivity.EXTRA_CAT;
import static com.JalenG.CityDiscovery.MainActivity.EXTRA_CREATOR;
import static com.JalenG.CityDiscovery.MainActivity.EXTRA_LAT;
import static com.JalenG.CityDiscovery.MainActivity.EXTRA_LIKE;
import static com.JalenG.CityDiscovery.MainActivity.EXTRA_LNG;
import static com.JalenG.CityDiscovery.MainActivity.EXTRA_URL;
...
public class DetailView extends FragmentActivity implements OnMapReadyCallback {
    ...
    void callDirections(double lat, double lng){
        String APIUrl = "https://maps.googleapis.com/maps/api/directions/json?origin=" + lat + "," + lng + "&destination=" + latLng.latitude + "," + latLng.longitude + "&key=***";
