...
public class MainActivity extends AppCompatActivity implements ExampleAdapter.OnItemClickListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!Places.isInitialized()) {
            Places.initialize(getApplicationContext(), "AIzaSyCgNqFvhXEyV7jsBTVZfWRH9WJQOovL87o");
        }
    ...
    private void getIDs(double lat, double lng) {
        ...
        String url = "https://api.foursquare.com/v2/venues/explore?ll=" + lat + "," + lng + "&limit=60&client_id=QAHINLW3LQFW121T2LWCMBOMEIAAPRZ3MZWPO13VU1IFOYUW&client_secret=YWTWHIMERTOU5HDI03JEQLCI2A5CDQ2VDJDJOAWPCVMZSUB5&v=20190603";
    ...
    private void parseJSON(String name, String city, final String catName){
            String APIUrl = "https://maps.googleapis.com/maps/api/place/findplacefromtext/json?input=" + name + city + "&inputtype=textquery&fields=photos,formatted_address,name,rating,opening_hours,geometry&key=AIzaSyCgNqFvhXEyV7jsBTVZfWRH9WJQOovL87o";
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, APIUrl, null, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        imageURL = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=" + photoRef + "&key=AIzaSyCgNqFvhXEyV7jsBTVZfWRH9WJQOovL87o";
